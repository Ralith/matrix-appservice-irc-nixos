...
let
  sources = {
    ...
    "irc-colors-1.4.1" = {
      ...
      version = "1.4.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/irc-colors/-/irc-colors-1.4.1.tgz";
        sha512 = "2l9lcwr3xgnv51fk9ddpcvisnbc5ysqialsd8rz0mfvkx7css90jzg0ycaddfhnpsgfhxr8dr27s4fln3z9vgk8lqh38nxc9g2kssd9";
      };
    };
    "when-3.4.6" = {
      name = "when";
    ...
    "localforage-1.5.5" = {
      ...
      version = "1.5.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/localforage/-/localforage-1.5.5.tgz";
        sha1 = "55fc1c3a88a47f67f5fac6f1231b25ff13556423";
      };
    };
    "mkdirp-0.5.1" = {
      name = "mkdirp";
...
in
{
  "matrix-appservice-irc-0.8.0" = nodeEnv.buildNodePackage {
